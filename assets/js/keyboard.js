const Keyboard = {
    ...
    _createKeys() {
        ...
        const keyLayout = [
            "1", "2", "3", "4", "5", "6", "7", "8", "9", "0",".", "backspace","close"
        ];
    ...
    _toggleCapsLock() {
        ...
        for (const key of this.elements.keys) {
            if (key.childElementCount === 0) {
                key.textContent = this.properties.capsLock ? key.textContent.toUpperCase() : key.textContent.toUpperCase();
            }
        }
    },
